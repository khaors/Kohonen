...
!============================================================================== 
   ...
   write(*,*) 'nvar1,nvar2,nvar= ',som_parameters(1)%number_variables1,&
                                   som_parameters(1)%number_variables2,&
                                   number_variables;
   allocate(var(som_parameters(1)%number_variables1,som_parameters(1)%number_variables2));
   ...
   read(ipar,'(A)') som_parameters(1)%som_type
...
!   
     ...
     do i=1,som_parameters(1)%number_patterns
        ...
        !write(*,*) (distance_matrix(i,j),j=1,som_parameters(1)%number_patterns);
     enddo
