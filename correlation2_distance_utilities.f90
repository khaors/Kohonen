...
!
   ...
   d=sqrt(((1.0d0-correlation)/(1.0d0+correlation))**0.1)
!
 end function calculate_correlation_distance


end module correlation2_distance_utilities